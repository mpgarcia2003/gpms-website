    ...
    const enhancedSchemas = [
      {
        ...
        telephone: "+1-844-814-0810", email: "info@greenpointms.com",
      ...
      },
      {
        ...
        description: richContent.definition,
        provider: { "@type": "LocalBusiness", name: "GreenPoint Maintenance Services Corp", telephone: "+1-844-814-0810", url: "https://greenpointms.com" },
        areaServed: { "@type": "City", name: city.name, containedInPlace: { "@type": "State", name: state.name } },
